...
public class ExerciceTests {
    ...
    @Test 
    public void listeAvecUneValeurZeroLimite(){
        //given  / ARRANGE
        final Exercice exercice = new Exercice();
        final List<Integer> listeEntiers = new ArrayList<>();
        listeEntiers.add(0);
        ...
        Entry<Integer, String> dualResult = actual.entrySet().iterator().next();
        Assertions.assertThat(dualResult.getKey()).isZero();
        Assertions.assertThat(dualResult.getValue()).isEqualTo("0 \n");
    }
    @Test 
    public void listeAvecUneValeurSuperieur21Limite(){
        //given  / ARRANGE
        final Exercice exercice = new Exercice();
        final List<Integer> listeEntiers = new ArrayList<>();
        listeEntiers.add(21);
    ...
    @Test
    public void listeAvecUneValeurplusUn(){
        //given  / ARRANGE
        final Exercice exercice = new Exercice();
        final List<Integer> listeEntiers = new ArrayList<>();
        listeEntiers.add(19);
        ...
        Entry<Integer, String> dualResult = actual.entrySet().iterator().next();
        Assertions.assertThat(dualResult.getKey()).isZero();
        Assertions.assertThat(dualResult.getValue()).isEqualTo("19 \n");
    }
    ...
    public void listeAvecTroisPositifsLimiteA2() {  //  EXERCICE 2:  Il reste un mutant en vie:  le corriger ici
        ...
        Entry<Integer, String> dualResult = actual.entrySet().iterator().next();
        Assertions.assertThat(dualResult.getKey()).isZero();
        Assertions.assertThat(dualResult.getValue()).isEqualTo("1 9 \n");
    }
